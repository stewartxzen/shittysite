...
const rustProducts = [
  {
    id: "Internal",
    name: "Rust Internal",
    image: "https://i.ibb.co/5W7YGp8d/menurust.png",
    description: "Advanced Combat & Enhancement Suite",
    startingPrice: "$9.99",
  ...
  },
  {
    ...
    description: "Premium Rust Enhancement",
    startingPrice: "$14.99",
    features: ["Rage Mode", "Full ESP", "Magic Bullet", "Speed Hack"],
  ...
  },
  {
    ...
    name: "Coming Soon!",
    image: "https://i.ibb.co/jdCjVd2/download-3.jpg",
    description: "Entry-level Rust Tools",
    startingPrice: "$4.99",
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold text-foreground mb-4">
            <span className="text-gradient">Rust</span> Products
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Choose from our selection of premium Rust enhancements
          </p>
        </div>

        {/* Products Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {rustProducts.map((product) => (
            <div
              key={product.id}
