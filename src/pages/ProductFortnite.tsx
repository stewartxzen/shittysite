        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-border glow-box">
              <img
                src="https://i.ibb.co/mrC7Z2yR/fn1.png"
                alt="Fortnite"
          ...
          <div className="bg-card rounded-2xl border border-border p-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full border border-primary/20 mb-6">
              <span className="text-primary font-semibold">🎮 Ultimate Battle Royale Toolkit</span>
            </div>
            ...
            <FeatureSection title="Combat Exploits" icon="💥" items={features.exploits} iconClass="text-yellow-500" />
            ...
            <FeatureSection title="Visual Tweaks" icon="🎨" items={features.worldTweaks} iconClass="text-purple-500" />
...
export default ProductFortnite;
